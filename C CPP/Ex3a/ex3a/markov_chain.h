...
typedef struct  MarkovNodeFrequency{
    struct MarkovNode * node;
    int frequency;
}MarkovNodeFrequency;

typedef struct MarkovNode{
    char* data;
    MarkovNodeFrequency *arr;
    int len_of_arr;
    int all_frequency;
}MarkovNode;
...
/**
 * Add the second markov_node to the frequency linked_list of the first
 * markov_node.
 * If already in linked_list, update it's occurrence frequency value.
 * @param first_node
 * @param second_node
